var key = '3fe613ce0f5933255968a83d8a700a9f';
var city = "Denver"
...
function getWeatherToday() {
	...
	$.ajax({
		...
		var getUrlUvi = `https://api.openweathermap.org/data/3.0/onecall?lat=${cityLat}&lon=${cityLon}&exclude=hourly,daily,minutely&appid=${key}`;
